...
public class Rook extends Piece {
	...
	//Rook can only move horizontally and vertically without any pieces in its desired directions.
	//Function is set to move maximum distance based on either y or x axis.
	@Override
